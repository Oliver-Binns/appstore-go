...
func TestRegisterDevice_MakesRequest(t *testing.T) {
	...
	httpClient := mocknetworking.MockHTTPClientWithSingleResponse(http.StatusCreated, `{"data":{"type":"devices","id":"69a495c9-7dbc-5733-e053-5b8c7c1155b0"}}`)
	...
	assert.Equal(t, "https://example.com/v1/devices", httpClient.Requests[0].URL.String())
