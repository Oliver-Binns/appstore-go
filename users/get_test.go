...
func TestGetUser_MakesRequest(t *testing.T) {
	...
	assert.Equal(t, httpClient.Requests[0].URL.String(), "https://example.com/v1/users/abcd1234-5678-90ab-cdef-1234567890ab?include=visibleApps")
}
...
func TestGetUser_MakesSecondRequestToInvitations_When404Returned(t *testing.T) {
	...
	assert.Equal(t, httpClient.Requests[1].URL.String(), "https://example.com/v1/userInvitations/abcd1234-5678-90ab-cdef-1234567890ab?include=visibleApps")
}
